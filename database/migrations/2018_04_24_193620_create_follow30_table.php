...
class CreateFollow30Table extends Migration {
	...
	public function up()
	{
		Schema::create('follow30', function(Blueprint $table)
		{
			$table->string('avc_monitoring', 5)->nullable();
			$table->bigInteger('id', true)->unsigned();
			$table->bigInteger('followup_id')->unsigned()->index('followup_id');
