		...
		<div class="panel-body">
            ...
            <div class="row form-group">
                ...
                <div class="col-xs-6 col-sm-4">
                    <input class="form-control" type="text" placeholder="Valor" v-model="follow_obj.glycemic_Hemoglobin_value" maxlength="6" :disabled="$verifyAccess(user) && !verifyGroup()">
                </div> 
                <div class="col-xs-6 col-sm-2 row">
            ...
            <div class="row form-group">
                ...
                <div class="col-xs-6 col-sm-4">
                    <input class="form-control" type="text" placeholder="Valor" v-model="follow_obj.ldl_value" maxlength="6" :disabled="$verifyAccess(user)">
                </div> 
                <div class="col-xs-6 col-sm-2 row">
...
export default {
  computed: {
    ...mapState({
      follow_obj: state => state.followup.ambulatory_care.follow2a,
