<template>
	<div class="panel panel-default">
		<div class="panel-heading">Followup - 30 dias</div>
		<div class="panel-body">
			<div class="row form-group">
                ...
                <jv-check-group gid="avc_monitoring" class="col-xs-12 col-sm-4" :value="follow_obj.avc_monitoring"
                           ...
                           @update="follow_obj.avc_monitoring = arguments[0]" :disabled="action === 'update' && $verifyAccess(user) && !verifyGroup()">
                </jv-check-group>
                <div class="col-xs-6 col-sm-2 row">
                    ...
                    @select="follow_obj.avc_monitoring_answer = arguments[0]" :disabled="action === 'update' && $verifyAccess(user) && !verifyGroup()"></jv-select>
                </div> 
            </div>
            ...
            <div class="row form-group" v-if="follow_obj.avc_monitoring_answer == 'ambulatory-cares-health-center-awnser-sim'">
                ...
                <jv-check-group gid="first-event-med-details" class="col-xs-12 col-sm-4" :value="follow_obj.fuespecialities"
                        ...
                        @update="follow_obj.fuespecialities = arguments[0]" :disabled="action === 'update' && $verifyAccess(user) && !verifyGroup()"></jv-check-group>
            </div>
            ...
            <div class="row form-group">
                ...
                <jv-select class="col-xs-12 col-sm-4 row" :value="follow_obj.frequency_health_center"
                           ...
                           @select="follow_obj.frequency_health_center = arguments[0]" :disabled="action === 'update' && $verifyAccess(user) && !verifyGroup()"></jv-select>
            </div>
            ...
            <div class="row form-group" v-if="follow_obj.physiotherapy">
                ...
                <jv-check-group gid="first-event-rehab-details" class="col-xs-12 col-sm-4" :value="follow_obj.especialities"
                        ...
                        @update="follow_obj.especialities = arguments[0]" :disabled="action === 'update' && $verifyAccess(user) && !verifyGroup()"></jv-check-group>
            </div>
            ...
            <div class="row form-group">
                ...
                <div class="col-xs-6 col-sm-4">
                    <input class="form-control" type="text" placeholder="Valor" v-model="follow_obj.glycemic_Hemoglobin_value" maxlength="6" :disabled="$verifyAccess(user)">
                </div> 
                <div class="col-xs-6 col-sm-2 row">
            ...
            <div class="row form-group">
                ...
                <div class="col-xs-6 col-sm-4">
                    <input class="form-control" type="text" placeholder="Valor" v-model="follow_obj.ldl_value" maxlength="6" :disabled="action === 'update' && $verifyAccess(user)">
                </div> 
                <div class="col-xs-6 col-sm-2 row">
            ...
            <div class="row form-group">
                ...
                <jv-select class="col-xs-12 col-sm-6 row" :value="follow_obj.smoking"
                           ...
                           @select="follow_obj.smoking = arguments[0]" :disabled="action === 'update' && $verifyAccess(user) && !verifyGroup()"></jv-select>
            </div>
            <div class="row form-group">
                <label class="col-xs-12 col-sm-6">
                ...
                :options="follow_obj.rankin_options" :time="page" @select="follow_obj.follow_rankin30 = arguments[0]" :disabled="action === 'update' && $verifyAccess(user)"></jv-rankin>
            </div>
            <div class="row form-group">
                <div class="col-xs-12">
            ...
            <div class="row form-group">
                ...
                <jv-select class="col-xs-12 col-sm-6 row" :value="follow_obj.nbperiods"
                           ...
                           @select="follow_obj.nbperiods = arguments[0]" :disabled="action === 'update' && $verifyAccess(user) && !verifyGroup()"></jv-select>
            </div>
            <div class="row form-group">
                <label class="col-xs-12 col-sm-6">
...
export default {
  computed: {
    ...mapState({
      follow_obj: state => state.followup.ambulatory_care.follow30,
  ...
  methods: {
    ...
    updateStatus(value) {
      this.follow_obj.physiotherapy = value;
    }
  }
};
</script>
